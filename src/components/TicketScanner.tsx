            ...
            <div className="p-6 sm:p-8 rounded-3xl border border-amber-500/50 bg-amber-950/40 space-y-6 shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl bg-[#D4AF37] text-black font-extrabold text-xs transition-all cursor-pointer flex items-center justify-center gap-2"
                >
                  <RefreshCw className="w-3.5 h-3.5" />
