      ...
      <header className="fixed top-0 inset-x-0 z-50 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 sm:pt-3">
          <nav className="bg-[#0A0A0C]/80 backdrop-blur-md rounded-2xl px-3 py-2 sm:px-5 sm:py-2.5 flex items-center justify-between shadow-[0_8px_30px_rgba(0,0,0,0.75)] border border-white/10 hover:border-white/15 transition-all duration-300">
            ...
            <Link to="/" className="flex items-center gap-2.5 cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37] rounded-xl p-0.5 shrink-0">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-[#141417] border border-white/10 overflow-hidden flex items-center justify-center group-hover:border-[#D4AF37]/40 transition-colors duration-300">
                <img
                  src="/favicon-192.png"
