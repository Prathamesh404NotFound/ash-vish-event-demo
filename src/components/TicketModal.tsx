      ...
      <div className="relative w-full max-w-md bg-[#141414] border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="p-4 bg-[#1C1C1C] flex flex-col sm:flex-row gap-2.5">
          ...
          <button
            ...
            className={`flex-1 py-2.5 px-3 rounded-xl bg-[#D4AF37] hover:bg-[#E3C456] text-black font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer ${
