    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#141414] via-[#1A1A1A] to-[#121212] border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <button
          ...
          className="py-3.5 px-6 rounded-2xl bg-[#D4AF37] hover:bg-[#E3C456] active:scale-95 text-black font-extrabold text-xs sm:text-sm flex items-center gap-2.5 transition-all cursor-pointer shrink-0"
        >
            ...
            <form onSubmit={handleSaveEvent} className="space-y-6 text-xs">
              ...
              <div className="pt-4 border-t border-white/10 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto py-3 px-7 rounded-xl bg-[#D4AF37] hover:bg-[#E3C456] active:scale-95 text-black font-extrabold text-xs transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isSaving ? (
                    <>
          ...
          >
            ...
            <form onSubmit={handleCloneEvent} className="space-y-3">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="py-2.5 px-5 rounded-xl bg-[#D4AF37] hover:bg-[#E3C456] active:scale-95 text-black font-extrabold text-xs cursor-pointer"
                >
                  Clone Event
                </button>
              </div>
            ...
            <form onSubmit={handleSendNotifications} className="space-y-3">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="py-2.5 px-5 rounded-xl bg-[#D4AF37] hover:bg-[#E3C456] active:scale-95 text-black font-extrabold text-xs cursor-pointer disabled:opacity-50"
                >
