...
Cashfree, bound to the reservation |
...
cashfree/create-order` requires a `reservationId`; the verify/finalize path re-checks the reservation is still active and locks it to the paid booking).
