...
const ENDPOINTS_TO_TEST: TestEndpoint[] = [
  ...
  { name: 'Register Organizer Requires Valid Account Token', path: '/api/organizers/register', method: 'POST', body: { userId: 'usr_smoke_1', name: 'Smoke Tester', email: 'smoke@test.com', organizationName: 'Smoke Events', phone: '1234567890' }, expectedStatus: [200, 401] },
